...
IF (BUILD_DOCS)
  ...
  SET (DOXYFILE_OUT ${CMAKE_INSTALL_PREFIX}/Doxyfile)
  ...
  SET (DOXYFILE_OUTPUT_DIR ${CMAKE_INSTALL_PREFIX}/doc/${PROJECT_NAME})
  SET (DOXYFILE_HTML_FILE ${CMAKE_INSTALL_PREFIX}/doc/${PROJECT_NAME}/html/index.html)

  CONFIGURE_FILE (${DOXYFILE_IN} ${DOXYFILE_OUT} @ONLY)
  ADD_CUSTOM_COMMAND (OUTPUT ${DOXYFILE_HTML_FILE}
                      COMMAND ${DOXYGEN_EXECUTABLE} ${CMAKE_INSTALL_PREFIX}/Doxyfile
